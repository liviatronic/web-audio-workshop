...
//setup pitch ADSR
const pitchEnvelope = new ADSREnvelope({
  audioContext
});
pitchEnvelope.attack = .5; //the envelope is controlling the pitch
pitchEnvelope.release = 1;
pitchEnvelope.connect(oscillator.detune, -2400); //pitch is lowering two octaves
