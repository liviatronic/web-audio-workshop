...
//setup bus and effects (compressor stops the audio from being overdriven)
...
const delay = new Delay({
  audioContext,
  //change these parameters to effect reverb
  feedback: .2,
  time: .2
});
...
//this refers to files in the audio>impulses folder
